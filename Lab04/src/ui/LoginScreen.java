...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(selectedPanel.getClass() == SupplierWorkAreaJPanel.class){
            if (selectedSupplier == null) {
                JOptionPane.showMessageDialog(this, "Please select a supplier to Login under Supplie role.");
                return;
            } else {
    ...
    public void populateSupplierCombo() {
        ...
        for(Supplier supplier : supplierDirectory.getSupplierList()){
            ...
            //addming supplier list to the combo box
    ...
    private void updateSupplierVisibility() {
         ...
         if (cmbRoles.getSelectedItem().equals(null)
