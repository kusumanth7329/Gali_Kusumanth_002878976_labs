...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        userProcessContainer.add("ViewProductDetailsJPanel", vpdp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Thank you for your purchase. Looking forward to see you agin!");
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please check the Modify quantity fields.");
            return;
        }
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(this, "The price should be more than it is set in the Price");
            return;
        }
        ...
        // Upating first and second tables
        populateProductTable();
        populateCartTable();
    ...
    //This method is to populate combo box automatically
    ...
    // To Populate the Product table without the arguments
    ...
    // Populate table with the arguments
